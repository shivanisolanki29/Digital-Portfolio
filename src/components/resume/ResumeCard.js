    ...
    <div className="w-full h-1/3 group flex ">
      ...
      >
        <div className="flex justify-between items-center ">
          ...
          <div>
            <p
              className="w-20 h-10 text-designColor bg-black bg-opacity-25rounded-lg 
        ...
        <p className="text-base font-medium text-gray group-hover:text-gray-300 duration-300">
          {des}
        </p>
      </div>
    </div>
