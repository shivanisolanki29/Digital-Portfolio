...
const SampleNextArrow = (props) => {
  ...
  return (
    <div
      className="w-14 h-12 bg-[#c1821] hover:bg-black 
      duration-300 rounded-md text-2xl text-gray-400 
      flex justify-center items-center absolute top-0
      right-0 shadow-shadowOne cursor-pointer z-10"
      onClick={onClick}
    >
      <HiArrowRight />
    </div>
...
const SamplePrevArrow = (props) => {
  ...
  return (
    ...
    duration-300 rounded-md text-2xl text-gray-400 
    flex justify-center items-center absolute top-0
    right-20 shadow-shadowOne cursor-pointer z-10"
      onClick={onClick}
    >
      <HiArrowLeft />
    </div>
            ...
            <div className="w-full h-auto flex flex-col lgl:flex-row justify-between gap-10">
              ...
              >
                ...
                <div className="flex flex-col justify-end">
                  ...
                  <h3 className="text-2xl font-bold"> JohnLuther</h3>
              ...
              <div className="w-full lgl:w-[65%] h-full flex flex-col justify-between">
                ...
                >
                  ...
                  >
                    ...
                    a pellentesque. Posuere morbi leo urna molestie at elementum
                    eu facilisis. Varius vel pharetra vel turpis nunc eget. Orci
            ...
            <div className="w-full h-[500px] flex flex-col lgl:flex-row justify-between gap-10">
              ...
              >
                ...
                <div className="flex flex-col justify-end">
                  ...
                  <h3 className="text-2xl font-bold"> Satya</h3>
                  <p className="text-base tracking-wide text-gray-500">
                    Senior Developer
                  </p>
                </div>
                ...
                >
                  <div className="flex justify-between items-center py-6 border-b-2 border-b-gray-900">
                    <div>
                      ...
                      <p className="text-base text-gray-400 mt-3">
                        via Upwork - Mar4, 2015-aug 30, 2021 test
                      </p>
                    </div>
                    <div className="text-yellow-500 flex gap-1">
                      <RiStarFill />
